...
const EmbedImage_1 = require("../model/EmbedImage");
 ...
 */
class Trello extends BaseProvider_1.BaseProvider {
    constructor() {
        super();
    ...
    disablePlugin() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const desc = MarkdownUtil_1.MarkdownUtil._formatMarkdown(manifest.details, embed);
                ...
                const thumbnail = new EmbedImage_1.EmbedImage();
            ...
            if (this.action.data.old != null) {
                ...
                if (old.name != null) {
                    ...
                    if (!old.desc) {
                        ...
                        embed.description = Trello._formatLargeString(MarkdownUtil_1.MarkdownUtil._formatMarkdown(this.action.data.card.desc, embed));
                    }
                    else if (!this.action.data.card.desc) {
                        embed.title = embed.title + 'Removed Description from Card "' + this.action.data.card.name + '"';
                        field = {
                            name: 'Old Value',
                            value: Trello._formatLargeString(MarkdownUtil_1.MarkdownUtil._formatMarkdown(old.desc, embed)),
                            inline: false
                        };
                    }
                    else {
            ...
            if (old != null) {
                if (old.prefs != null) {
                    ...
                    if (!old.desc) {
                        ...
                        embed.description = Trello._formatLargeString(MarkdownUtil_1.MarkdownUtil._formatMarkdown(organization.desc, embed));
                    }
                        ...
                        embed.description = Trello._formatLargeString(MarkdownUtil_1.MarkdownUtil._formatMarkdown(old.desc, embed)) + '\n`\uD83E\uDC6B`\n' + Trello._formatLargeString(MarkdownUtil_1.MarkdownUtil._formatMarkdown(organization.desc, embed));
                    }
                }
            }
            else {
...
Trello.baseLink = 'https://trello.com/';
Trello.baseAvatarUrl = 'https://trello-avatars.s3.amazonaws.com/';
Trello.defTrelloColors = {
    blue: 0x0079bf,
    yellow: 0xd9b51c,
    orange: 0xd29034,
    green: 0x519839,
