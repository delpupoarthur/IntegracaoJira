 ...
 */
class BitBucket extends BaseProvider_1.BaseProvider {
    constructor() {
        super();
    ...
    issueCreated() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.body.issue.content.raw) {
                states.push('**Content:**\n' + MarkdownUtil_1.MarkdownUtil._formatMarkdown(BitBucket._formatLargeString(this.body.issue.content.raw), this.embed));
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof this.body.changes !== 'undefined') {
                ...
                });
                {
                    ...
                    const property = this.body.changes[label.toLowerCase()];
                    if (typeof property !== 'undefined') {
                        changes.push('**New ' + label + ':** \n' + MarkdownUtil_1.MarkdownUtil._formatMarkdown(BitBucket._formatLargeString(property.new), this.embed));
                    }
                }
            }
            this.embed.description = changes.join('\n');
    ...
    issueCommentCreated() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.embed.url = this.extractIssueUrl();
            this.embed.description = MarkdownUtil_1.MarkdownUtil._formatMarkdown(BitBucket._formatLargeString(this.body.comment.content.raw), this.embed);
            this.addEmbed(this.embed);
        });
    }
    pullrequestCreated() {
